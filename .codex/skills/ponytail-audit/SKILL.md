---
name: ponytail-audit
description: Audit the entire repo for over-engineering — what can be deleted across the whole tree, not a diff, not correctness. Trigger when the user wants a repo-wide over-engineering / dead-code audit.
---
...
End with the net lines and dependencies removable. If nothing to cut: `Lean already. Ship.`
